...
// sign extension
#define SIGN_EXTEND4(a) (((a)&0x8)?(0x0000000f&(a)):(0xfffffff0|(a)))
...
// zero extension
#define ZERO_EXTEND4(a) ((a)&0x0000000f)
#define ZERO_EXTEND8(a) ((a)&0x000000ff)
#define ZERO_EXTEND12(a) ((a)&0x00000fff)
#define ZERO_EXTEND16(a) ((a)&0x0000ffff)
